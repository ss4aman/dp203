...
export class LinkEntity {
    ...
    async _negotiateClaim({ abortSignal, setTokenRenewal, timeoutInMs, }) {
        ...
        if (!this._context.cbsSession.isOpen()) {
            await defaultCancellableLock.acquire(this._context.cbsSession.cbsLock, () => this._context.cbsSession.init({
                abortSignal,
        ...
        await defaultCancellableLock.acquire(this._context.negotiateClaimLock, () => this._context.cbsSession.negotiateClaim(this.audience, tokenObject.token, tokenType, {
            abortSignal,
            timeoutInMs: timeoutInMs - (Date.now() - startTime),
        }), {
            abortSignal,
